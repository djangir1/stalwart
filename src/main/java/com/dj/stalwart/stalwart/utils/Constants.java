...
public class Constants {
    ...
    public static final String LOGIN_STATUS_NEW = "NEW_USER";
    public static final String LOGIN_STATUS_ACTIVE = "ACTIVE_USER";
    public static final String LOGIN_STATUS_EXISTING = "EXISTING_USER";
    public static final String LOGIN_STATUS_INVALID = "INVALID_USER";
